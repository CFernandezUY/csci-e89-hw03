...
Reproduces the learning-curve plot from "Building an Image Classifier
with PyTorch" (Chapter 10, Hands-On ML with Scikit-Learn and PyTorch,
Geron 2025): accuracy per epoch alongside loss per epoch, saved to a PNG.
"""
